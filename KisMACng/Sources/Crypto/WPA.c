...
bool wpaTestPasswordHash() {
    ...
    wpaPasswordHash("password", "IEEE", 4, out);
    ...
    wpaPasswordHash("ThisIsAPassword", "ThisIsASSID", 11, out);
    ...
    hmac_md5("Hi There", 8, "\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b", 16, out);
    if (memcmp(out, "\x92\x94\x72\x7a\x36\x38\xbb\x1c\x13\xf4\x8e\xf8\x15\x8b\xfc\x9d", 16))
        return false;
    
    hmac_md5("what do ya want for nothing?", 28, "Jefe", 4, out);
    if (memcmp(out, "\x75\x0c\x78\x3e\x6a\xb0\xb5\x03\xea\xa8\x6e\x31\x0a\x5d\xb7\x38", 16))
        return false;

    PRF("\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b", 20, "prefix", 6, "Hi There", 8, out, 64);
    ...
    PRF("Jefe", 4, "prefix", 6, "what do ya want for nothing?", 28, out, 64);
