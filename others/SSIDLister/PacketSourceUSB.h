...
#include "USBIntersilJack/USBIntersil.h"
#define PacketSourceUSBAvailable

class PacketSourceUSB : public PacketSource {
private:
	USBIntersilJack *_driver;
	unsigned char _frame[3000];
	unsigned int _channel;
	unsigned short _allowedChannels;
	bool _destructing;
	pthread_t _hopper;
