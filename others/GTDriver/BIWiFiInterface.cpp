...
OSDefineMetaClassAndStructors( BIWiFiInterface, IONetworkInterface )
OSMetaClassDefineReservedUnused( BIWiFiInterface,  0);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  1);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  2);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  3);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  4);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  5);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  6);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  7);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  8);
OSMetaClassDefineReservedUnused( BIWiFiInterface,  9);
OSMetaClassDefineReservedUnused( BIWiFiInterface, 10);
OSMetaClassDefineReservedUnused( BIWiFiInterface, 11);
OSMetaClassDefineReservedUnused( BIWiFiInterface, 12);
OSMetaClassDefineReservedUnused( BIWiFiInterface, 13);
OSMetaClassDefineReservedUnused( BIWiFiInterface, 14);
OSMetaClassDefineReservedUnused( BIWiFiInterface, 15);

// The name prefix for all BSD Ethernet interfaces.
// 
#define kBIWiFiInterfaceNamePrefix      "wlan"
...
UInt32 BIWiFiInterface::getFilters(const OSDictionary * dict,
...
bool BIWiFiInterface::setFilters(OSDictionary *   dict,
                                     const OSSymbol * group,
                                     UInt32           filters)
{
    OSNumber * num;
...
//---------------------------------------------------------------------------
// Initialize an BIWiFiInterface instance. Instance variables are
// initialized, and an arpcom structure is allocated.

bool BIWiFiInterface::init(IONetworkController * controller)
{
    OSData * macAddr;
    ...
    macAddr = OSDynamicCast(OSData, controller->getProperty("IOMACAddress2"));
    ...
    if ( _arpcom == 0 )
    {
        DLOG("BIWiFiInterface: arpcom allocation failed\n");
        return false;
    }
...
// to an ifnet structure obtained through getIfnet(). BIWiFiInterface
...
bool BIWiFiInterface::initIfnet(struct ifnet * ifp)
{
    super::initIfnet( ifp );
...
//---------------------------------------------------------------------------
// Free the BIWiFiInterface instance. The memory allocated
// for the arpcom structure is released.

void BIWiFiInterface::free()
{
    if ( _arpcom )
    {
...
// by the family specific interface object. BIWiFiInterface
...
ifnet_t BIWiFiInterface::getIfnet() const
{
...
const char * BIWiFiInterface::getNamePrefix() const
{
    return kBIWiFiInterfaceNamePrefix;
}
...
// interface. BIWiFiInterface uses this method to inspect the controller,
...
bool BIWiFiInterface::controllerDidOpen(IONetworkController * ctr)
{
    bool                 ret = false;
    OSData *             addrData;
    ...
    do {
        ...
        addrData = OSDynamicCast(OSData, ctr->getProperty("IOMACAddress2"));
...
//
// BIWiFiInterface will ensure that the controller is disabled.
//
// controller: The currently opened controller object.

void BIWiFiInterface::controllerWillClose(IONetworkController * ctr)
{
...
//    arg1 - (void *)
//
// The commands handled by BIWiFiInterface are:
//
//    SIOCSIFADDR
//    SIOCSIFFLAGS
//    SIOCADDMULTI
...
SInt32 BIWiFiInterface::performCommand( IONetworkController * ctr,
                                            UInt32                cmd,
                                            void *                arg0,
                                            void *                arg1 )
{
        ...
        case SIOCSIFLLADDR:
            ret = (int) ctr->executeCommand(
                             ...
                             (IONetworkController::Action)
                                &BIWiFiInterface::performGatedCommand,
                             this,            /* target */
                             ctr,             /* param0 */
                             (void *) cmd,    /* param1 */
                             arg0,            /* param2 */
...
int BIWiFiInterface::performGatedCommand(void * target,
                                             void * arg1_ctr,
                                             void * arg2_cmd,
                                             void * arg3_0,
                                             void * arg4_1)
{
    BIWiFiInterface * self = (BIWiFiInterface *) target;
...
IOReturn BIWiFiInterface::enableController(IONetworkController * ctr)
{
    ...
    do {
        ...
        OSData * lladdr = OSDynamicCast(OSData, getProperty("IOMACAddress2"));
...
SInt BIWiFiInterface::syncSIOCSIFADDR(IONetworkController * ctr)
{
    IOReturn ret = kIOReturnSuccess;
...
SInt BIWiFiInterface::syncSIOCADDMULTI(IONetworkController * ctr)
{
    IOReturn ret;
...
SInt BIWiFiInterface::syncSIOCDELMULTI(IONetworkController * ctr)
{
...
int BIWiFiInterface::syncSIOCSIFMTU( IONetworkController * ctr,
                                         struct ifreq *        ifr )
{
...
int BIWiFiInterface::syncSIOCSIFLLADDR( IONetworkController * ctr,
                                            const char * lladdr, int len )
{
    ...
    if ( ret == kIOReturnSuccess )
    {
        ...
        setProperty("IOMACAddress2", (void *)lladdr, len);
...
IOReturn 
BIWiFiInterface::enableFilter_Wrapper(BIWiFiInterface *self, IONetworkController *ctr, const OSSymbol *group, UInt32 filters, IOOptionBits options)
{
	return self->enableFilter(ctr, group, filters, options);
}

IOReturn
BIWiFiInterface::enableFilter(IONetworkController * ctr,
                                  const OSSymbol *      group,
                                  UInt32                filters,
                                  IOOptionBits          options)
{
    ...
    if ( options & kFilterOptionNotInsideGate )
    {
    	...
    	return ctr->executeCommand(
                           this,               /* client */
                           (IONetworkController::Action)
                               &BIWiFiInterface::enableFilter_Wrapper,
                           this,               /* target */
                           (void *) ctr,       /* param0 */
                           (void *) group,     /* param1 */
                           (void *) filters,   /* param2 */
...
IOReturn
BIWiFiInterface::disableFilter(IONetworkController * ctr,
                                   const OSSymbol *      group,
                                   UInt32                filters,
                                   IOOptionBits          options)
{
...
IOReturn
BIWiFiInterface::setupMulticastFilter(IONetworkController * ctr)
{
    void *               multiAddrs = 0;
    UInt                 mcount;
    OSData *             mcData = 0;
...
IOReturn
BIWiFiInterface::controllerWillChangePowerState(
...
IOReturn
BIWiFiInterface::controllerDidChangePowerState(
                               IONetworkController * ctr,
                               IOPMPowerFlags        flags,
                               UInt32                stateNumber,
                               IOService *           policyMaker )
...
IOReturn BIWiFiInterface::setProperties( OSObject * properties )
{
    IOReturn       ret;
...
bool BIWiFiInterface::willTerminate( IOService *  provider,
                                         IOOptionBits options )
{
    ...
    {
        DLOG("BIWiFiInterface::willTerminate disabling controller\n");
...
IOReturn BIWiFiInterface::attachToDataLinkLayer( IOOptionBits options,
                                                     void *       parameter )
{
    IOReturn ret = super::attachToDataLinkLayer( options, parameter );
    if ( ret == kIOReturnSuccess )
    {
        bpfattach( getIfnet(), DLT_IEEE802_11, sizeof(struct ether_header) );
    }
    return ret;
}
