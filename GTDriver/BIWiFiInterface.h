...
#ifndef _BIWiFiInterface_H
#define _BIWiFiInterface_H

/*! @defined kBIWiFiInterfaceClass
    @abstract kBIWiFiInterfaceClass is the name of the
        BIWiFiInterface class. */

#define kBIWiFiInterfaceClass     "BIWiFiInterface"

/*! @defined kIOActivePacketFilters
    @abstract kIOActivePacketFilters is a property of BIWiFiInterface
    ...
    @discussion The kIOActivePacketFilters property describes the current
        ...
        all filter change requests from the BIWiFiInterface object. */

#define kIOActivePacketFilters        "IOActivePacketFilters"

/*! @defined kIORequiredPacketFilters
    @abstract kIORequiredPacketFilters is a property of BIWiFiInterface
        objects. It has an OSDictionary value.
...
/*! @defined kIOMulticastAddressList
    @abstract kIOMulticastAddressList is a property of BIWiFiInterface
...
/*! @class BIWiFiInterface : public IONetworkInterface
...
class BIWiFiInterface : public IONetworkInterface
{
    OSDeclareDefaultStructors( BIWiFiInterface )
...
private:
	...
	static IOReturn enableFilter_Wrapper(BIWiFiInterface *, IONetworkController *, const OSSymbol *, UInt32 , IOOptionBits);

public:

/*! @function init
    @abstract Initialize an BIWiFiInterface instance.
...
/*! @function free
    @abstract Free the BIWiFiInterface instance.
...
/*! @function controllerDidOpen
    ...
    BIWiFiInterface will first call the implementation in its
...
/*! @function initIfnet
    ...
    @discussion BIWiFiInterface will initialize this structure in a manner
...
/*! @function getIfnet
    ...
    BIWiFiInterface will allocate an arpcom structure during init(),
...
public:
    ...
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  0);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  1);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  2);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  3);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  4);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  5);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  6);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  7);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  8);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface,  9);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface, 10);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface, 11);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface, 12);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface, 13);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface, 14);
    OSMetaClassDeclareReservedUnused( BIWiFiInterface, 15);
};

#endif /* defined(KERNEL) && defined(__cplusplus) */

#endif /* !_BIWiFiInterface_H */
